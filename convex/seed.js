...
Light refreshments will be provided. Limited seats available.`,
  ...
  {
  title: "Tech Meetup Bhopal - Web & AI",
  description: `Join developers and tech enthusiasts from Bhopal for an exciting meetup on Web Development and AI.

Topics include:
- React & Next.js trends
- AI tools for developers
- Networking with local devs

Snacks and networking included.`,
  category: "tech",
  tags: ["tech", "ai", "web"],
  city: "Bhopal",
  state: "Madhya Pradesh",
  venue: "https://maps.google.com/?q=DB+Mall+Bhopal",
...
{
  title: "Pharmacy & Clinical Research Seminar",
  description: `A professional seminar for pharmacy students and healthcare professionals.

Topics include:
- Drug development process
- Clinical trials & regulations
- Career opportunities in pharmacy
- Hospital vs industrial roles

Guest speakers from leading pharma companies.
...
Certificates will be provided.`,
  ...
  city: "Bhopal",
  state: "Madhya Pradesh",
  venue: "https://maps.google.com/?q=LNCT+Bhopal",
  address: "LNCT College, Kalchuri Nagar, Bhopal",
  capacity: 80,
  ticketType: "free",
  coverImage: 
...
{
  title: "Frontend Developer Meetup - React & UI",
  description: `Join Bhopal's developer community for an interactive frontend meetup.
...
Networking + Q&A session included.`,
  category: "tech",
  tags: ["react", "frontend", "javascript"],
  city: "Bhopal",
  state: "Madhya Pradesh",
  venue: "https://maps.google.com/?q=MP+Nagar+Bhopal",
...
{
  title: "Cricket Tournament - Bhopal League",
  description: `Local cricket tournament for amateur players in Bhopal.
...
Open for all skill levels.`,
  ...
  city: "Bhopal",
  state: "Madhya Pradesh",
  venue: "https://maps.google.com/?q=TT+Nagar+Stadium+Bhopal",
  address: "TT Nagar Stadium, Bhopal",
  capacity: 100,
  ticketType: "paid",
  ticketPrice: 199,
  coverImage:
